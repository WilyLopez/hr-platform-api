...
class RechazarSolicitudUseCase(BaseUseCase[EvaluarSolicitudInputDTO, SolicitudOutputDTO]):
    def __init__(
        self,
    ...
    def execute(self, input_dto: EvaluarSolicitudInputDTO) -> SolicitudOutputDTO:
        ...
        solicitud.rechazar(input_dto.evaluado_por_id, input_dto.comentario or "Sin comentario.")
        ...
        self._auditoria_use_case.registrar(
            ...
            tipo_evento=TiposEvento.RECHAZO_SOLICITUD,
            descripcion=f"Solicitud {solicitud.id} rechazada.",
            ip_address=None,
            detalles={"solicitud_id": solicitud.id, "comentario": input_dto.comentario},
        )
